...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/sureshkumar-s" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/sureshkumar-s/" },
  { icon: Mail, link: "mailto:sureshkumar.s@example.com" },
];
